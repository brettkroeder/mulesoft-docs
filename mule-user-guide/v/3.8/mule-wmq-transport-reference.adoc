...
Before you can use the Mule WMQ transport, you must copy the following JARs from the `java/lib` directory under your WebSphere MQ home directory into the `lib/user` directory under your Mule home directory (ex: `studio-home/contents/eclipse/plugins/org.mule.tooling.server.3.8.1.ee_6.1.1.201609121705/mule/lib/user`:
